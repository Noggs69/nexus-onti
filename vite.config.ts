...
export default defineConfig({
  ...
  server: {
    headers: {
      ...
      'Content-Security-Policy': "default-src 'self'; connect-src 'self' http://localhost:5000 ws://localhost:5000 https://js.pusher.com https://*.pusher.com wss://*.pusher.com https://yvywmlrkoabdweygucvb.supabase.co wss://yvywmlrkoabdweygucvb.supabase.co; script-src 'self' https://js.pusher.com 'unsafe-inline' 'unsafe-eval'; worker-src 'self' blob:; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:;"
    }
  }
});
